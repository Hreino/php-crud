  ...
  <body>
        ...
        <div class="container-fluid">
            ...
            <li><a href="login.php">Iniciar Sesión</a></li>
                <li><a href="agregarUsuarios.php">Regístrate!</a></li>
        ...
        <div class="row">
            ...
            <li><a href="index.php">Inicio</a></li>
                <li class="active"><a href="agregarUsuarios.php">Nuevo Usuario</a></li>
            ...
            <h1 class="page-header text-center">Formulario de Datos para nuevos Usuarios</h1>
            ...
            $rows=$controlador->Buscar($_GET["idmodificar"]);
            ...
            ?>
                ...
                //apertura del ciclo
                    ...
                    <div class="row ">
                        ...
                        <label for="">ID</label>
                        <input type="text" class="form-control" name="id" value="<?php print($item->id); ?>" placeholder="Digite su nombre" readonly="readonly">
                        <label for="">Nombre</label>
                        <input type="text" class="form-control" name="nuevoNombre" value="<?php print($item->nombre); ?>" placeholder="Digite su nombre" required>
                        <label for="">Usuario</label>
                        <input type="text" name="nuevoUser" class="form-control" value="<?php print($item->usuario); ?>" placeholder="Digite su username" required>
                        <label for="">Contraseña</label>
                        <input type="password" name="NuevaContra" class="form-control" value="<?php print($item->contrasenia); ?>" placeholder="Digite su contraseña" required>
                        <br><br>
                        <input type="submit" value="Guardar" name ="btnmodif" class="btn btn-primary" >
