          ...
          <div class="row placeholders col-md-offset-5"/>
                ...
                <div class="row ">
                    ...
                    <form action="usuarios.php" method="POST">
                      ...
                      <input type="text" name="user" class="form-control" placeholder="Digite su username" required>
                      <label for="">Contraseña</label>
                      <input type="password" name="contra" class="form-control" placeholder="Digite su contraseña" required>
                      <br><br>
                      <input type="submit" value="Guardar" name ="btnsave" class="btn btn-primary" >
